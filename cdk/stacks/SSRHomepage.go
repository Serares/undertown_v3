...
type SSRHomepageProps struct {
	awscdk.StackProps
	Env string
}

type SSRHomepageReturn struct {
...
func SSRHomepage(scope constructs.Construct, id string, props *SSRHomepageProps) SSRHomepageReturn {
