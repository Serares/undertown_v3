// ❗
// even though there has been a lot of work involed into this
// sadly I have to drop the usage of the scripts just for the sake of making pages
// SPA hybrid
// all the updates will be made SSR
// Deprecated
function QueryProperties(
  sortFormElement,
  filterFormElement,
  propertiesRowElement
) {
...
QueryProperties.prototype.sendRequestForData = function (e, pageNumber) {
  ...
  if (e.type == "DOMContentLoaded") {
    this.formData.append(
      "PROPERTY_TYPE_HP",
      document.querySelector("#property_type").value
    );
  }
            ...
            <div class="col-md-12">
                <div class="property_list_1 property_item bg-white mb_30">
                    <div class="zoom_effect_1"> 
                     <a href="/${createPropertyPath(property.status)}/${
        property._id
      }">
                     ...
                     <div class="upper_2">
                        ...
                        <div class="float-right property_list_details p-3">
                            <div class="property_text">
                                <h5 class="title">
                                    <a href="/${createPropertyPath(
                                      property.status
                                    )}/${property._id}">${property.titlu}</a>
                                </h5>
...
function SortAndFilterProperties(
  ...
  this.xmlRequest.onerror = function () {
    console.log("Got an error" + this.xmlRequest.response);
  };
}
...
try {
  ...
  var filterPropertiesInstance = new SortAndFilterProperties(
    sortFormElement,
    filterFormElement,
    propertiesRowElement
  );
  var paginationRenderer = new PaginationRender(
    sortFormElement,
    filterFormElement,
    propertiesRowElement
  );
