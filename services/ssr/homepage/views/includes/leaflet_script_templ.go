...
func LeafletMap(lat string, lng string) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_LeafletMap_4087`,
		Function: `function __templ_LeafletMap_4087(lat, lng){function BuildLeafletMap(lat, lng, mapId) {
        this.mapId = mapId;
        this.lat = +lat;
        this.lng = +lng;
        this.zoomLevel = 15;
    ...
    var leaflet_map = new BuildLeafletMap(lat, lng, mapId);
		...
		Call:       templ.SafeScript(`__templ_LeafletMap_4087`, lat, lng),
		CallInline: templ.SafeScriptInline(`__templ_LeafletMap_4087`, lat, lng),
	}
}
